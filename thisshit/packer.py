# Делает что-то типа коробочек с объектами, коробочки вызываемые, к примеру коробка из функций вызывает каждую свою функцию, а numeric соединяет цифры в 1 число, в случае типа int.
